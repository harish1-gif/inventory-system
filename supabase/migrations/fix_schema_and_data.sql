-- Migration to fix database schema and enable data display in UI
-- This migration adds missing tables, columns, and functions

-- Step 1: Create purifier_models table if it doesn't exist
...
-- Step 2: Add missing columns to customers table
...
-- Step 3: Update call_enquiries table structure (drop and recreate to ensure correct schema)
...
-- Step 4: Create indexes for call_enquiries
...
-- Step 6: Create trigger function for updating customer last_service_date
...
-- Step 8: Create trigger function for call_enquiries timestamp
...
-- Step 9: Create trigger for call_enquiries
